...
CONNECTION_STRING = "HostName=EZ10PyIot.azure-devices.net;DeviceId=UbuntuPC;SharedAccessKey=FEJm+csVJliDpldi1XJDlDOl07OESXgUL1DawuesxpA="

##MSG_TXT = "{\"deviceId\": \"myPythonDevice\",\"windSpeed\": %.2f,\"temperature\": %.2f,\"humidity\": %.2f}"
MSG_TXT = "{\"deviceId\": \"UbuntuPC\",\"windSpeed\": %.2f,\"temperature\": %.2f,\"humidity\": %.2f}"
